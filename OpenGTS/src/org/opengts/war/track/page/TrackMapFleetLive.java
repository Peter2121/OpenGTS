    ...
    extends TrackMap
{
    ...
    public TrackMapFleetLive()
    {
        ...
        this.setPageNavigation(new String[] { PAGE_LOGIN, PAGE_PASSWD, PAGE_MENU_TOP, PAGE_ZONE_INFO, PAGE_SYSADMIN_ACCOUNTS, PAGE_ACCOUNT_INFO, PAGE_USER_INFO, PAGE_GROUP_INFO, PAGE_DEVICE_INFO, PAGE_MAP_FLEET, PAGE_MAP_DEVICE });
