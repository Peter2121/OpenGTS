    ...
    implements Constants
{
    ...
    public AccountInfo()
    {
        ...
        this.setPageNavigation(new String[] { PAGE_LOGIN, PAGE_PASSWD, PAGE_MENU_TOP, PAGE_ZONE_INFO, PAGE_SYSADMIN_ACCOUNTS, PAGE_USER_INFO, PAGE_UGROUP_INFO, PAGE_DEVICE_INFO, PAGE_MAP_FLEET, PAGE_MAP_DEVICE, PAGE_MAP_FLEETLIVE });
